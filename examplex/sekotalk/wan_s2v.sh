...
lightx2v_path=./
model_path=/data/ai-models/wan2.2/Wan2.2-S2V-14B
...
--config_json ${lightx2v_path}/examplex/sekotalk/wan_s2v.jsonc \
...
--save_result_path ${lightx2v_path}/save_results/s2v_fp8_v1.mp4
