...
# set path firstly
lightx2v_path=./
model_path=/data/ai-models/wan2.2/Wan2.2-T2V-A14B
...
--config_json ${lightx2v_path}/examplex/wan2.2/wan_moe_i2v.json \
...
--save_result_path ${lightx2v_path}/save_results/wan_moe_i2v_v1.mp4
